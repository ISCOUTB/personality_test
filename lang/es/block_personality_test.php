...
$string['personality_test_actived'] = 'Test de personalidad activado';
...
$string['titulo_resultados_estudiantes'] = 'Resultados de los Estudiantes'; // Para la vista del bloque del profesor
...
$string['pdf_report_title'] = 'Reporte del Test de Personalidad';

$string['pdf_report_subject'] = 'Resultados del Test de Personalidad para el curso: {$a}';
...
$string['sin_datos_estudiantes_pdf'] = 'No hay datos de estudiantes para generar el PDF.'; // Mensaje para la redirección si no hay datos

$string['sin_datos_estudiantes'] = 'Aún no hay resultados de estudiantes para mostrar.'; // Mensaje para el bloque si no hay datos
...
$string['Sensing'] = 'Sensación'; // O 'Sensing' si lo prefieres

$string['Intuicion'] = 'Intuición'; // O 'Intuition' - Asegúrate que la clave coincida exactamente con la usada en el PHP (con o sin tilde)

$string['Pensamiento'] = 'Pensamiento'; // O 'Thinking'

$string['Sentimiento'] = 'Sentimiento'; // O 'Feeling'

$string['Juicio'] = 'Juicio'; // O 'Judging'

$string['Percepcion'] = 'Percepción'; // O 'Perceiving' - Asegúrate que la clave coincida exactamente con la usada en el PHP (con o sin tilde)
